...
const CartItems = () => {
  const { getTotalCartAmmount, all_products, cartItems, removeFromCart } =
          ...
          {all_products.map((e) => {
            if (cartItems[e.id] > 0) {
              return (
                <tr
                  key={e.id}
                  className="border-b border-slate-900/20 p-6 text-gray-30 medium-14 text-center"
                >
        ...
        <div className=" flex flex-col gap-10 ">
          ...
          <div>
            ...
            <div className="flexBetween  py-4">
              ...
              <h4 className="bold-18">${getTotalCartAmmount()}</h4>
            </div>
          </div>
