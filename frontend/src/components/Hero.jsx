...
const Hero = () => {
  return (
    <section className="realtive bg-hero bg-cover bg-center bg-np-repeat h-screen w-full">
      <div className="max_padd_contaniner relative top-32 xs:top-52">
        ...
        <p className="text-gray-50 regular-16 mt-6 max-w-[33rem]">
          ...
          fugit perspiciatis alias quidem modi quos ut eaque natus aliquam cum
          est itaque tenetur vero, dolor nobis non velit perferendis laborum.
          Rerum, fugit.
        </p>
